const AddTask = () => {
  ...
  // შემიძლია დეპარტამენტები, სტატუსი,პრიორიტეტები ცალკე კომპონენტად ატომებში გავიტანო რომელსაც გადაეცემა 2
  // პროპსი title რა სათაურიც ექნება და endpoint, და ამ ენდოინთზე გავაგზავნო თვითონ კომპონენტში რექუესთი
  // და ისე დავარენდერო მოდალის ჩამოშლის დროს, ასევე ღილაკზე დაჭერის დროს თუ ვალიდაციები სწორადაა როდესაც
  // ტასკი დაემატება ავტომატურად უნდა გადამიყვანოს მთავარ გვერდზე.
  // დღეს უნდა გავაკეთო AddTaskPage ზე სრული ვალიდაციები, ასევე უნდა დაემატოს ტასკი როგორც ბექში ასევე ქარდი
  // უნდა გამოჩნდეს ვიზუალურად და უბრალოდ ამ ტასკზე ID - ის მიხედვით უნდა გადავიყვანო ფეიჯზე
